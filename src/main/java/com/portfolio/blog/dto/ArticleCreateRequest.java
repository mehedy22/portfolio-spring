...
/**
 * {@code content} is HTML and is sanitized on write against an allow-list (D-027) — what comes
 * back on the response is what was actually stored, which may be less than what was sent.
 */
